    ...
    <div class="container mt-6">
        <div class="row d-flex align-items-center">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <?= $form->field($model, 'designacao')
                        ...
                        ->label('Designação:', ['class' => 'form-label'])
                    ?>
                </div>

                <div class="mb-3">
                    <?= $form->field($model, 'componentes')
                        ->textInput(['maxlength' => false, 'class' => 'form-control'])
                        ->label('Componentes:', ['class' => 'form-label'])
                    ?>
                </div>
                ...
                <div class="mb-3">
                    <?= $form->field($model, 'tipo')
                        ->dropDownList(
                            [
                                'sopa' => 'Sopa',
                                'prato normal' => 'Prato Normal',
                                'prato vegetariano' => 'Prato Vegetariano'
                            ],
                            ['prompt' => 'Selecione um.', 'class' => 'form-control dropdown-with-arrow']
                        )
                        ->label('Tipo:', ['class' => 'form-label'])
                    ?>
                </div>
            ...
            <div class="text-center col-md-6">
                <img src="<?= Yii::getAlias('@web/images/prato.png') ?>" alt="Imagem ilustrativa" class="img-fluid" style="width: 28vw">
            </div>
        </div>
    </div>
</div>
